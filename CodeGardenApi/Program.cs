...
builder.Services.AddDbContext<CodeGardenContext>(options =>
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "CodeGarden API", Version = "v1" });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "CodeGarden API V1");
});
